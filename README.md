...
```bash
cd tools/midi-tone
python3 -m unittest test_sequencer test_phrase_pads test_synth_vibrato test_jambox_client test_updater
xvfb-run -a python3 -m unittest test_ui_seq test_ui_settings     # builds the real Tk screen with stub audio/MIDI
```
