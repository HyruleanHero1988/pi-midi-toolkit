...
```bash
cd tools/midi-tone
python3 -m unittest test_sequencer test_kaoss test_phrase_pads test_synth_vibrato test_jambox_client
xvfb-run -a python3 -m unittest test_ui_seq test_ui_kaoss     # builds the real Tk screen with stub audio/MIDI
```
