...
**Jambox FX:** per-wavetable / per-drum-model drive → delay → light reverb via **FX MODE** (not a global mix bus). Open KIT to point knobs at a drum voice; otherwise they edit the nearer morph wave.
