...
Open [`docs/index.html`](docs/index.html) in a browser for labeled 800×480 captures of every mode (SYNTH, SEQ, PADS, KAOSS, SONGS, PRESETS, LOG) and the VOICES / MORPH / KIT / POWER / SAVE AS / KAOSS scales / FULL PAD overlays.
