...
| Blank / solid dark screen, process running | Idle burn-in guard, or duplicate app instances | Tap the panel or play a note; `pkill -f midi_tone.py`; check a single `kiosk.sh`; reboot once |
