...
| Nav shell / HOME | Top chrome (PiDI / HOME / POWER / jam tabs); Home `HOME_TILES` including MAP |
...
| MAP | Home MIDI utility: 4×4 input channels 1–16; tap to pick output channel(s). Remapped cells show destinations. |
| FX | BUS / VOICE / DRUMS target; DRIVE / DELAY / REVERB / **FLANGE** (bus = global wet; voice mirrors SYNTH FLANGE) |
| SETTINGS | Appliance hub: Panic, notes-off, **AUDIO**, **WIFI**, **UPDATE**, FONT, LOG, PORTS |
